...
export default function SocialCard({ img, title, description, buttons, avatar }: CardProps) {
    return (
        <div className="h-84 w-64 mt-2 mb-2 dark:bg-black-Card bg-white-Card text-blackText rounded-xl dark:text-whiteText mr-10 transition-colors duration-750 ease-in-out dark:shadow-DarkOcean shadow-xl/25  shadow-enderBlack select-none">
